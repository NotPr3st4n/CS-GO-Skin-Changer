...
constexpr const int GetWeaponPaint(const short& itemDefinition)
{
	...
	case 4: return 680; // glock
	case 7: return 255; // ak
	case 9: return 662; // awp
	case 61: return 653; // usp
	case 28: return 514; // negev
	case 11: return 294; // G3SG1
	case 38: return 391; // SCAR20
	case 19: return 636; // P90
	case 30: return 644; // TEC9
	case 39: return 3; // SG556
	case 40: return 361; // SSG08
	case 60: return 430; // M4A1-S
	default: return 0;
	}
}
	...
	while (true)
	{
		...
		for (const auto& handle : weapons)
		{
			...
			if (const auto paint = GetWeaponPaint(memory.Read<short>(weapon + offset::m_iItemDefinitionIndex)))
			{
				...
				//memory.Write<std::int32_t>(weapon + offset::m_iAccountID, memory.Read<std::int32_t>(weapon + ofsset::m_OriginalOwnerXuidLow));
